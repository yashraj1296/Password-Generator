...
function SetPass_lenght(){
    ...
    Input_slider.style.backgroundSize=((Password_lenght-min)*100/(max-min))+"%";
}
...
function SetColor(color){
    ...
    Indicator_color.style.boxShadow = color+' 0px 0px 54px, '+color+' 0px 2px 12px';
}
...
function Pass_strenght(){
    ...
    else if((hasUpper || hasLower) && (hasNumber||hasSymbol) && Password_lenght>=6) {
        SetColor("#ff0")
    }
